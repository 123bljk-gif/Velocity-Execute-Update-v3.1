...
[![Stars](https://img.shields.io/github/stars/Velocity-Execute-Update-v3.1?style=flat-square)](https://github.com)
...
git clone https://github.com/Velocity-Execute-Update-v3.1.git
cd Velocity-Execute-Update-v3.1
